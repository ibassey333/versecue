#!/usr/bin/env python3
"""
Fix audio capture with better debugging
"""
import os
...
def main():
    print("=" * 60)
    print("Adding Debug Logging to Audio Capture")
    print("=" * 60)
    ...
    print("3. Check console for [VerseCue] logs")
    print("4. Speak and watch for 'Speech detected!'")
    print("=" * 60)
