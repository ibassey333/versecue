  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      <div className="text-center py-16">
        ...
        <h1 className="text-2xl font-bold text-verse-text mb-2">Session History</h1>
        <p className="text-verse-muted mb-6">Your saved sermon sessions will appear here.</p>
